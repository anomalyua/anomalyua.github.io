        ...
        <div className="sppb-row sppb-align-center">
              ...
              <div className="sppb-column-addons">
                <div id="sppb-addon-wrapper-1542712445474" className="sppb-addon-wrapper">
                  <div id="sppb-addon-1542712445474" className="clearfix ">
                    <div
                      className="sppb-addon sppb-addon-person sppb-text-center  non-box-shadow person-content-position-bottom-left">
                      <div className="sppb-addon-content">
                        <div className="sppb-person-image ">
                          ...
                          <div className="person-content-show-on-hover">
                            <div className="person-content-hover-content-wrap"/>
                          </div>
                        </div>
                        <div className="sppb-person-information">
                          <span className="sppb-person-name">
                            {gettext('David Plaster')}
                          </span>
                          <span className="sppb-person-designation">
                            {gettext('Founder & Chairman')}
                          </span>
                        </div>
                      </div>
                    </div>
          ...
          <PageColumn8>
            <div id="column-id-1542711300770" className="sppb-column">
              <div className="sppb-column-addons">
                <div id="sppb-addon-wrapper-1542712137722" className="sppb-addon-wrapper">
                  <div id="sppb-addon-1542712137722" className="clearfix ">
                    <div className="sppb-addon sppb-addon-header  text-color-op6 sppb-text-left"><h2
                ...
                <div id="sppb-addon-wrapper-1542711301041" className="sppb-addon-wrapper">
                  <div id="sppb-addon-1542711301041" className="clearfix ">
                ...
                <div id="sppb-addon-wrapper-1542712190422" className="sppb-addon-wrapper">
                  <div className="sppb-addon sppb-addon-text-block  ">
                    <div className="sppb-addon-content">
                      <DescriptionBlock>
                        {gettext('David\'s favorite way to describe himself is as a "mere pensioner." ' +
                ...
                <section id="section-id-1632999046152" className="sppb-section">
                  ...
                  <div className="sppb-row-container">
                    <div className="sppb-row">
                      <PageColumn8>
                        <DescriptionText>
                          {gettext('Today our team includes hundreds of volunteers from more than 12 ' +
      ...
      <div className="sppb-row-container">
        <div className="row">
          <PageColumn4>
            <OurTeamColumn>
              <TitleLevel3>
                {gettext('Volunteering opportunities')}
              </TitleLevel3>
            </OurTeamColumn>
          </PageColumn4>
          <PageColumn8>
            <DescriptionText>
              {gettext('Anomaly provides a wide range of volunteering opportunities in Ukraine. We have ' +
        ...
        <PageColumn8>
          <div id="column-id-1542888546597" className="sppb-column">
            <div className="sppb-column-addons">
                    ...
                    <div className="sppb-addon-content sppb-text-left">
                      <div className="sppb-media">
                        <div className="pull-left">
                          <div className="sppb-icon"><span className="sppb-icon-container" aria-label="Phone"><i
                            className="fa fa-phone" aria-hidden="true"/></span></div>
                        </div>
                        <div className="sppb-media-body">
                          <div className="sppb-media-content">
                            <h2 className="sppb-addon-title sppb-feature-box-title sppb-media-heading">
                              {gettext('Phone')}
                            </h2>
              ...
              <div id="sppb-addon-wrapper-1542951075011" className="sppb-addon-wrapper">
                <div id="sppb-addon-1542951075011" className="clearfix ">
                  <div className="sppb-addon-divider-wrap divider-position">
                    <div className="sppb-divider sppb-divider-border link-color-opt3"/>
                  </div>
                </div>
                ...
                <div id="sppb-addon-1542888956811" className="clearfix ">
                  <div className="sppb-addon sppb-addon-feature sppb-text-left address-info">
                    <div className="sppb-addon-content sppb-text-left">
                      <div className="sppb-media">
                        <div className="pull-left">
                          <div className="sppb-icon"><span className="sppb-icon-container" aria-label="Address"><i
                            className="fa fa-map-o" aria-hidden="true"/></span></div>
                        </div>
                        <div className="sppb-media-body">
                          <div className="sppb-media-content">
                            <h2 className="sppb-addon-title sppb-feature-box-title sppb-media-heading">
                            ...
                            <div className="sppb-addon-text">
                              {gettext('Velyka Vasylkivska st, 72, office 20,\nUkraine, 03150, Kyiv')}
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <div id="sppb-addon-wrapper-1542888978160" className="sppb-addon-wrapper">
                <div id="sppb-addon-1542888978160" className="clearfix ">
                  <div className="sppb-addon-divider-wrap divider-position">
                    <div className="sppb-divider sppb-divider-border link-color-opt3"/>
                  </div>
                </div>
                ...
                <div id="sppb-addon-1542951075020" className="clearfix ">
                  <div className="sppb-addon sppb-addon-feature sppb-text-left address-info">
                    <div className="sppb-addon-content sppb-text-left">
                      <div className="sppb-media">
                        <div className="pull-left">
                          <div className="sppb-icon"><span className="sppb-icon-container" aria-label="Email"><i
                            className="fa fa-envelope-o" aria-hidden="true"/></span></div>
                        </div>
                        <div className="sppb-media-body">
                          <div className="sppb-media-content">
                            <h2 className="sppb-addon-title sppb-feature-box-title sppb-media-heading">
              ...
              <div id="sppb-addon-wrapper-1542951075017" className="sppb-addon-wrapper">
                <div id="sppb-addon-1542951075017" className="clearfix ">
                  <div className="sppb-addon-divider-wrap divider-position">
                    <div className="sppb-divider sppb-divider-border link-color-opt3"/>
                  </div>
                </div>
            ...
            <div className="sp-column ">
              <div className="sp-page-title" style={{ backgroundImage: 'url(../images/IMG_1408.jpg)' }}>
                <div className="container">
                  <TopTitleText>{gettext('About Us')}</TopTitleText>
                </div>
              </div>
            </div>
          </div>
