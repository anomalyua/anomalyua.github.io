            ...
            <div className="sp-column ">
              ...
              <div id="sp-page-builder" className="sp-page-builder  page-45">
                <div className="page-content">
                                ...
                                <div id="sppb-addon-1626723958919" className="clearfix ">
                                  <div className="sppb-addon sppb-addon-text-block  ">
                                    <div className="sppb-addon-content">
                                        <span
                                          data-sheets-value="{&quot;1&quot;:2,&quot;2&quot;:&quot;Anomaly has helped to organize 40 waste clean ups in neighborhoods all around Kyiv and 15 more around Ukraine. If you would like to host a local clean up- Anomaly can show you how! &quot;}"
                                          data-sheets-userformat="{&quot;2&quot;:769,&quot;3&quot;:{&quot;1&quot;:0},&quot;11&quot;:4,&quot;12&quot;:0}">
                                          <span style={{ fontSize: '18pt' }}>
                                            {gettext('Anomaly has helped to organize 40 waste clean ups in neighborhoods all around ' +
                                  ...
                                  <div className="sppb-addon sppb-addon-single-image sppb-text-center ">
                                    <div className="sppb-addon-content">
                                      <div className="sppb-addon-single-image-container"><img
                                        className="sppb-img-responsive" src="/images/img_0552.jpg" alt="Image" title/>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div id="sppb-addon-wrapper-1626726032082" className="sppb-addon-wrapper">
                                <div id="sppb-addon-1626726032082" className="clearfix ">
                                  <div className="sppb-addon sppb-addon-single-image sppb-text-center ">
                                    <div className="sppb-addon-content">
                                      <div className="sppb-addon-single-image-container"><img
                                        className="sppb-img-responsive" src="/images/shooterscreenshot-0-30-09-21.png"
                                        alt="Image" title/></div>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div id="sppb-addon-wrapper-1626726032085" className="sppb-addon-wrapper">
                                <div id="sppb-addon-1626726032085" className="clearfix ">
                                  <div className="sppb-addon sppb-addon-text-block  ">
                                    <div className="sppb-addon-content">
                                        <span style={{ fontSize: '18pt' }}
                                              data-sheets-value="{&quot;1&quot;:2,&quot;2&quot;:&quot;LoveUA is a Ukrainian ecology platform made of an association of ecology groups and activists to track and solve eco problems in Ukraine&quot;}"
                                              data-sheets-userformat="{&quot;2&quot;:513,&quot;3&quot;:{&quot;1&quot;:0},&quot;12&quot;:0}">
                                          {gettext('LoveUA is a Ukrainian ecology platform made of an ' +
                                            'association of ecology groups and activists to track and solve eco problems in Ukraine')}
                                        </span>
                                    </div>
                                  </div>
                                </div>
                  ...
                  <section id="section-id-1633809907290"
                    ...
                    <div className="sppb-row-container">
                      <div className="sppb-row sppb-align-center">
                        <div className="sppb-col-md-7" id="column-wrap-id-1633809907310">
                          <div id="column-id-1633809907310" className="sppb-column">
                            <div className="sppb-column-addons">
                              <div id="sppb-addon-wrapper-1633809907311" className="sppb-addon-wrapper">
                                <div id="sppb-addon-1633809907311" className="clearfix ">
                                  <div className="sppb-addon sppb-addon-header sppb-text-center"><h2
                                    className="sppb-addon-title">
                                    {gettext('Do you want to make Ukraine green again? Join our ' +
                                      'team and make our home a cleaner, greener place for generations to come!')}
                                  </h2></div>
                                </div>
                              </div>
                            </div>
                          ...
                          <div id="column-id-1633809907312" className="sppb-column">
                            <div className="sppb-column-addons">
                              <div id="sppb-addon-wrapper-1633809907313" className="sppb-addon-wrapper">
                                <div id="sppb-addon-1633809907313" className="clearfix sppb-positioned-addon"
                                     data-rowid={1633809907290} data-colid={1633809907312}>
