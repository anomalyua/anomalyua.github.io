      ...
      <ul className="sppb-nav sppb-nav-tabs" role="tablist">
        ...
        <li className={secondActive && 'active'}>
          ...
          >
            ...
            {' '}
            {gettext('Miltary medical training')}
            {' '}
          </a>
        </li>
        <li className={thirdActive && 'active'}>
          ...
          >
            ...
            {' '}
            {gettext('Social Media Marketing training')}
            {' '}
          </a>
        </li>
      </ul>
            ...
            <div id="sppb-addon-1633859757" className="clearfix ">
              <div className="sppb-addon sppb-addon-text-block  ">
                <div className="sppb-addon-content">
                  {gettext('Developed leadership courses for women where they are typically underrepresented; ' +
        ...
        >
          <div id="sppb-addon-wrapper-1633859758765" className="sppb-addon-wrapper">
            <div id="sppb-addon-1633859758765" className="clearfix ">
              <div className="sppb-addon sppb-addon-text-block  ">
                <div className="sppb-addon-content">
                  {gettext('Trained over 8000 military, volunteers, and national guardsmen in NATO miltary ' +
        ...
        >
          <div id="sppb-addon-wrapper-1633859758766" className="sppb-addon-wrapper">
            <div id="sppb-addon-1633859758766" className="clearfix ">
              <div className="sppb-addon sppb-addon-text-block  ">
                <div className="sppb-addon-content">
                  {gettext('Offered courses in SMM, videography, and PR communications to government ' +
            ...
            <div className="sp-column ">
              <div className="sp-page-title" style={{ backgroundImage: 'url(/images/IMG_0835.jpg)' }}>
                <div className="container">
                  <TopTitleText>{gettext('Education')}</TopTitleText>
                </div>
              </div>
            </div>
          </div>
              ...
              <div id="sp-page-builder" className="sp-page-builder  page-48">
                <div className="page-content">
                                  ...
                                  <div className="sppb-addon sppb-addon-feature  ">
                                    <div className="sppb-addon-content sppb-text-center">
                                      <div className="sppb-icon"><span className="sppb-icon-container" aria-label><i
                                        className="fas fa-spell-check" aria-hidden="true"/></span></div>
                                      <div className="sppb-media-content">
                                        <div className="sppb-addon-text">{gettext('English')}</div>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div id="sppb-addon-wrapper-1633849194918" className="sppb-addon-wrapper">
                                <div id="sppb-addon-1633849194918" className="clearfix ">
                                  <div className="sppb-addon sppb-addon-feature  ">
                                    <div className="sppb-addon-content sppb-text-center">
                                      <div className="sppb-icon"><span className="sppb-icon-container" aria-label><i
                                        className="fas fa-share-alt" aria-hidden="true"/></span></div>
                                      <div className="sppb-media-content">
                                        <div className="sppb-addon-text">
                                          {gettext('Social Media Marketing')}
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                            ...
                            <div className="sppb-column-addons">
                              <div id="sppb-addon-wrapper-1633000411934" className="sppb-addon-wrapper">
                                <div id="sppb-addon-1633000411934" className="clearfix ">
                                  <div className="sppb-addon sppb-addon-text-block  ">
                                    <div className="sppb-addon-content">
                                      {gettext('20,000+ members of underserved communities taught, including Ukrainian veterans ' +
                  ...
                  <section id="section-id-1633849194953" className="sppb-section">
                    <div className="sppb-row-container">
                      <div className="sppb-row">
                        <div className="sppb-col-md-5" id="column-wrap-id-1633849194939">
                          <div id="column-id-1633849194939" className="sppb-column">
                            <div className="sppb-column-addons">
                              <div id="sppb-addon-wrapper-1633849194940" className="sppb-addon-wrapper">
                                <div id="sppb-addon-1633849194940" className="clearfix ">
                                  <div className="sppb-addon sppb-addon-single-image sppb-text-center ">
                                    <div className="sppb-addon-content">
                                      <div className="sppb-addon-single-image-container"><img
                                        className="sppb-img-responsive" src="/images/img_3318-1.jpg" alt="Image" title/>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                          ...
                          <div id="column-id-1633849194941" className="sppb-column">
                            <div className="sppb-column-addons">
                              <div id="sppb-addon-wrapper-1633849194943" className="sppb-addon-wrapper">
                                <div id="sppb-addon-1633849194943" className="clearfix sppb-positioned-addon"
                                     data-rowid={1633849194953} data-colid={1633849194941}>
                                  <div className="sppb-addon sppb-addon-text-block  ">
                                    <div className="sppb-addon-content">
                                      <p>
                                        {gettext('We organized English-language conversation and craft sessions for younger ' +
                  ...
                  <section id="section-id-1633812940770"
                    ...
                    <div className="sppb-row-container">
                      <div className="sppb-row sppb-align-center">
                        <div className="sppb-col-md-7" id="column-wrap-id-1633812940790">
                          <div id="column-id-1633812940790" className="sppb-column">
                            <div className="sppb-column-addons">
                              <div id="sppb-addon-wrapper-1633812940791" className="sppb-addon-wrapper">
                                <div id="sppb-addon-1633812940791" className="clearfix ">
                                  <div className="sppb-addon sppb-addon-header sppb-text-center"><h2
                                    className="sppb-addon-title">
                                    {gettext('Do you have something that you want to teach to others? Come join us!')}
                                  </h2></div>
                                </div>
                              </div>
                            </div>
                          ...
                          <div id="column-id-1633812940792" className="sppb-column">
                            <div className="sppb-column-addons">
                              <div id="sppb-addon-wrapper-1633812940793" className="sppb-addon-wrapper">
                                <div id="sppb-addon-1633812940793" className="clearfix sppb-positioned-addon"
                                     data-rowid={1633812940770} data-colid={1633812940792}>
