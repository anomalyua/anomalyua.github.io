...
<div className="sppb-text-left"><a href="#" id="btn-1542709917009" className="sppb-btn  sppb-btn-link sppb-btn-rounded">
Join Today<i className="fa fa-long-arrow-right" aria-hidden="true" /></a></div>
</div>
                </div>
              </div>
            </div>
            ...
            <div id="column-id-1620541326160" className="sppb-column">
              <div className="sppb-column-addons">
                <div id="sppb-addon-wrapper-1620541326161" className="sppb-addon-wrapper">
                  <div id="sppb-addon-1620541326161" className=" sppb-wow fadeIn clearfix  sppb-animated sppb-animated sppb-animated" data-sppb-wow-duration="800ms" data-sppb-wow-delay="300ms" style={{
...
<div className="sppb-addon-content sppb-text-left"><div className="sppb-media"><div className="pull-sppb-text-left"><span className="sppb-img-container">
        <Link to='/veterans'>
        ...
        resources to better serve people in Ukraine.</div></div></div></div></div>
</div>
        </div>
                </div>
              </div>
            ...
            <div id="column-id-1620541326162" className="sppb-column">
              <div className="sppb-column-addons">
                <div id="sppb-addon-wrapper-1633616058151" className="sppb-addon-wrapper">
                  <div id="sppb-addon-1633616058151" className=" sppb-wow fadeIn clearfix  sppb-animated sppb-animated sppb-animated" data-sppb-wow-duration="800ms" data-sppb-wow-delay="100ms" style={{
            ...
            <div id="column-id-1620541326164" className="sppb-column">
              <div className="sppb-column-addons">
                <div id="sppb-addon-wrapper-1620541326159" className="sppb-addon-wrapper">
                  <div id="sppb-addon-1620541326159" className=" sppb-wow fadeIn clearfix  sppb-animated sppb-animated" data-sppb-wow-duration="800ms" data-sppb-wow-delay="100ms" style={{
 visibility: 'visible', animationDuration: '800ms', animationDelay: '100ms', animationName: 'fadeIn' 
}}>
          <div className="sppb-addon sppb-addon-feature  service-item item1">
<div className="sppb-addon-content sppb-text-left"><div className="sppb-media"><div className="pull-sppb-text-left"><span className="sppb-img-container">
        ...
        educational modules and workshops.</div></div></div></div></div>
</div>
        </div>
                </div>
              </div>
            ...
            <div id="column-id-1633010662537" className="sppb-column">
              <div className="sppb-column-addons">
                <div id="sppb-addon-wrapper-1633616058146" className="sppb-addon-wrapper">
                  <div id="sppb-addon-1633616058146" className=" sppb-wow fadeIn clearfix  sppb-animated sppb-animated sppb-animated" data-sppb-wow-duration="800ms" data-sppb-wow-delay="500ms" style={{
...
<div className="sppb-addon-content sppb-text-left"><div className="sppb-media"><div className="pull-sppb-text-left"><span className="sppb-img-container">
          ...
          <p>We support faster problem solving with local governance by providing
            ...
            of Kyiv, directly connecting them with local utility service providers.</p></div></div></div></div></div>
</div>
            </div>
                </div>
              </div>
            ...
            <div id="column-id-1633616058147" className="sppb-column">
              <div className="sppb-column-addons">
                <div id="sppb-addon-wrapper-1620541326165" className="sppb-addon-wrapper">
                  <div id="sppb-addon-1620541326165" className=" sppb-wow fadeIn clearfix  sppb-animated sppb-animated" data-sppb-wow-duration="800ms" data-sppb-wow-delay="700ms" style={{
...
<div className="sppb-addon-content sppb-text-left"><div className="sppb-media"><div className="pull-sppb-text-left"><span className="sppb-img-container">
          ...
          speaking clubs. <br />Anomaly connects foreign donors with an orphanage in Mariupol to help children find a new family and home.<br />We work with the local community policing department to protect the rights of children in Kyiv.</div></div></div></div></div>
</div>
        </div>
                </div>
              </div>
            ...
            <div id="column-id-1633616058148" className="sppb-column">
              <div className="sppb-column-addons">
                <div id="sppb-addon-wrapper-1620541326163" className="sppb-addon-wrapper">
                  <div id="sppb-addon-1620541326163" className=" sppb-wow fadeIn clearfix  sppb-animated sppb-animated" data-sppb-wow-duration="800ms" data-sppb-wow-delay="500ms" style={{
 visibility: 'visible', animationDuration: '800ms', animationDelay: '500ms', animationName: 'fadeIn' 
}}>
...
<div className="sppb-addon-content sppb-text-left"><div className="sppb-media"><div className="pull-sppb-text-left"><span className="sppb-img-container">
          ...
          to solve the problem of stray animal overpopulation.<br /> <br />We are always looking for volunteers to help us solve this problem. If you think that is you, then join us today!.</div></div></div></div></div>
</div>
            </div>
                </div>
              </div>
...
<div className="sppb-addon sppb-addon-wayne-corp-image sppb-addon-single-image sppb-text-center "><div className="sppb-addon-content"><div className="sppb-addon-single-image-container">
<a className="sppb-magnific-popup sppb-addon-image-overlay-icon" data-popup_type="image" data-mainclass="mfp-no-margins mfp-with-zoom" href="http://anomaly.planet-it.com.ua/images/galary/img_1464.jpeg">+</a><img className="sppb-img-responsive" src="images/img_1464.jpeg" alt="Image" /></div></div></div>
</div>
                </div>
              </div>
            </div>
...
<div className="sppb-addon sppb-addon-wayne-corp-image sppb-addon-single-image sppb-text-center "><div className="sppb-addon-content"><div className="sppb-addon-single-image-container">
<a className="sppb-magnific-popup sppb-addon-image-overlay-icon" data-popup_type="image" data-mainclass="mfp-no-margins mfp-with-zoom" href="http://anomaly.planet-it.com.ua/images/galary/img_1355.jpg">+</a><img className="sppb-img-responsive" src="images/img_1355.jpg" alt="Image" /></div></div></div>
</div>
                </div>
                <div id="sppb-addon-wrapper-1620586929521" className="sppb-addon-wrapper">
                  <div id="sppb-addon-1620586929521" className="clearfix ">
<div className="sppb-addon sppb-addon-wayne-corp-image sppb-addon-single-image sppb-text-center "><div className="sppb-addon-content"><div className="sppb-addon-single-image-container">
<a className="sppb-magnific-popup sppb-addon-image-overlay-icon" data-popup_type="image" data-mainclass="mfp-no-margins mfp-with-zoom" href="http://anomaly.planet-it.com.ua/images/galary/img_0835.jpeg">+</a><img className="sppb-img-responsive" src="images/img_0835.jpeg" alt="Image" /></div></div></div>
</div>
                </div>
              </div>
            </div>
...
<div className="sppb-addon sppb-addon-wayne-corp-image sppb-addon-single-image sppb-text-center "><div className="sppb-addon-content"><div className="sppb-addon-single-image-container">
<a className="sppb-magnific-popup sppb-addon-image-overlay-icon" data-popup_type="image" data-mainclass="mfp-no-margins mfp-with-zoom" href="http://anomaly.planet-it.com.ua/images/galary/img_3256.jpeg">+</a><img className="sppb-img-responsive" src="images/img_3256.jpeg" alt="Image" /></div></div></div>
</div>
                </div>
                <div id="sppb-addon-wrapper-1620586929524" className="sppb-addon-wrapper">
                  <div id="sppb-addon-1620586929524" className="clearfix ">
<div className="sppb-addon sppb-addon-wayne-corp-image sppb-addon-single-image sppb-text-center "><div className="sppb-addon-content"><div className="sppb-addon-single-image-container">
<a className="sppb-magnific-popup sppb-addon-image-overlay-icon" data-popup_type="image" data-mainclass="mfp-no-margins mfp-with-zoom" href="http://anomaly.planet-it.com.ua/images/galary/img_1604.jpeg">+</a><img className="sppb-img-responsive" src="images/img_1604.jpeg" alt="Image" /></div></div></div>
</div>
                </div>
              </div>
            </div>
...
<div className="sppb-addon sppb-addon-wayne-corp-image sppb-addon-single-image sppb-text-center "><div className="sppb-addon-content"><div className="sppb-addon-single-image-container">
<a className="sppb-magnific-popup sppb-addon-image-overlay-icon" data-popup_type="image" data-mainclass="mfp-no-margins mfp-with-zoom" href="http://anomaly.planet-it.com.ua/images/galary/img_1038.jpeg">+</a><img className="sppb-img-responsive" src="images/img_1038.jpeg" alt="Image" /></div></div></div>
</div>
                </div>
              </div>
            </div>
...
<div className="sppb-addon sppb-addon-wayne-corp-image sppb-addon-single-image sppb-text-center "><div className="sppb-addon-content"><div className="sppb-addon-single-image-container">
<a className="sppb-magnific-popup sppb-addon-image-overlay-icon" data-popup_type="image" data-mainclass="mfp-no-margins mfp-with-zoom" href="http://anomaly.planet-it.com.ua/images/galary/img_0703.jpeg">+</a><img className="sppb-img-responsive" src="images/img_0703.jpeg" alt="Image" /></div></div></div>
</div>
                </div>
              </div>
            </div>
...
<div className="sppb-text-center"><a id="btn-1633802035300" className="sppb-btn  sppb-btn-default sppb-btn-rounded">
Go<i className="fas fa-arrow-right" aria-hidden="true" /></a></div>
</div>
                </div>
              </div>
            </div>
