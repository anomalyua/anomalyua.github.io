          ...
          <div className="sp-column ">
            <div className="sp-page-title" style={{ backgroundImage: 'url(/images/vet_3.jpg)' }}>
              <div className="container">
                <TopTitleText>Veterans</TopTitleText>
              </div>
            </div>
          </div>
        </div>
                          ...
                          <div className="sppb-column-addons">
                            <div id="sppb-addon-wrapper-1626723958919" className="sppb-addon-wrapper">
                              <div id="sppb-addon-1626723958919" className="clearfix ">
                                <div className="sppb-addon sppb-addon-text-block  ">
                                  <div className="sppb-addon-content">
                                    <span style={{ fontSize: '16pt' }} data-sheets-value="{&quot;1&quot;:2,&quot;2&quot;:&quot;Drinkin' Bros is an international veterans organization and we run the Ukrainian chapter. Come grab a drink with us! We offer a cool environment to meet with other veterns like yourself. Don't drink? It's okay - have something non-alcoholic! :) The important thing that we don't drink alone!&quot;}" data-sheets-userformat="{&quot;2&quot;:769,&quot;3&quot;:{&quot;1&quot;:0},&quot;11&quot;:4,&quot;12&quot;:0}" data-sheets-textstyleruns="{&quot;1&quot;:0}[null,270,{&quot;6&quot;:1}]">
                                      Drinkin' Bros is an international veterans organization and we run the Ukrainian chapter.
                                      <br />
                                      Come grab a drink with us! We offer a cool environment to meet with other veterns like yourself.
                                      <br />
                          ...
                          <div className="sppb-column-addons">
                            <div id="sppb-addon-wrapper-1626726032085" className="sppb-addon-wrapper">
                              <div id="sppb-addon-1626726032085" className="clearfix ">
                                <div className="sppb-addon sppb-addon-text-block  ">
                                  <div className="sppb-addon-content">
                                    <span style={{ fontSize: '16pt' }} data-sheets-value="{&quot;1&quot;:2,&quot;2&quot;:&quot;We also help to connect vets with caretakers, social workers, and psychological support. We have organized a network of 1000+ veteran care specialists from all over the country to help assist veterans with their transition to civilian life and recovery after returning from war. &quot;}" data-sheets-userformat="{&quot;2&quot;:769,&quot;3&quot;:{&quot;1&quot;:0},&quot;11&quot;:4,&quot;12&quot;:0}">
                                      We also help to connect vets with caretakers, social workers, and psychological support.
                                      <br />
                                      We
                        ...
                        <div id="column-id-1633808655256" className="sppb-column">
                          <div className="sppb-column-addons">
                            <div id="sppb-addon-wrapper-1633808655257" className="sppb-addon-wrapper">
                              <div id="sppb-addon-1633808655257" className="clearfix sppb-positioned-addon" data-rowid={1633808655233} data-colid={1633808655256}>
